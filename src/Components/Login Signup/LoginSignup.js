        ...
        <div className="overlay-container">
            <div className="overlay">
                ...
                <div className="overlay-panel overlay-right">
                    <h1>Welcome!</h1>
                    <p>Enter your personal details and start your journey on TECHONICLE with us</p>
                ...
                <div className="overlay-panel overlay-left">
                    <h1>Welcome Back!</h1>
                    <p>To explore the world of TECHONICLE with us please login with your personal info</p>
