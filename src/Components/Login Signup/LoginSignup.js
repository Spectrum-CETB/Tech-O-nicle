...
function LoginSignup() {
  ...
  const handleSubmit = (e) => {
    ...
    axios({
      method: "data",
      url: "https://spectrumoutr.com/techonicle/register.php",
      data: user,
    })
      .then((res) => {
        if (res.data.status) {
  ...
  const loggingin = (e) => {
    ...
    axios({
      method: "data",
      url: "https://spectrumoutr.com/techonicle/login.php",
      data: logUser,
    })
      .then((res) => {
        if (res.data.status) {
        ...
        if (res.data.status === false) {
          ...
          alertme.classList.add("alert-success");
          checkSvg.attributes[0].value = "#check-circle-fill";
          // adding the item to session!
          sessionStorage.setItem("user", res.data.user);
          // getting the item from session!
    ...
    return (
      <>
        ...
        <div className="container__1 ">
          <div
            className="alert alert-success d-flex align-items-center hidden"
            role="alert"
            id={"alert"}
          >
            <svg
              ...
              role="img"
            >
              <use xlinkHref="#check-circle-fill" id={"check-svg"} />
            </svg>
          ...
          <div
            className={
              rightPanel
                ? "container container_3 right-panel-active"
            ...
            <div className="overlay-container">
              <div className="overlay">
                <div className="overlay-panel overlay-right">
                  <h1>Welcome!</h1>
                  <p className="para">
                    Enter your personal details and start your journey on
                    TECHONICLE with us
                  </p>
                  <p className="para">Already have an account?</p>
                  <button
                    className="ghost signIn mt-3"
                    id="signIn"
                ...
                <div className="overlay-panel overlay-left">
                  <h1>Welcome Back!</h1>
                  <p className="para">
                    To explore the world of TECHONICLE with us please login with
                    your personal info
                  </p>
                  <p className="para">Not a member yet?</p>
                  <button
                    className="ghost signUp mt-3"
                    id="signUp"
