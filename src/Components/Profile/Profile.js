...
export class Profile extends Component {
  ...
  UNSAFE_componentWillMount() {
    axios
      .get(
        "https://spectrumoutr.com/techonicle/getProfile.php?email=" +
          this.state.user
      )
      .then((res) => {
        if (res.data.status) {
    ...
    axios
      .get(
        "https://spectrumoutr.com/techonicle/get-user-blogs.php?email=" +
          this.state.user
      )
      .then((res) => {
        if (res.data.status) {
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-md-8 pt-md-3 pe-4 profile-text text-center text-md-start">
              ...
              <p className="mt-2">
                Product Design and Resource Management LIVE WORLD INC.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row blogs mx-md-1 mx-lg-5">
            <div className="col-md-4 col-lg-3 ms-lg-5 px-md-3 px-lg-4 my-3 contacts">
              <div className="mt-1">
                ...
                <span className="ms-1"> St. Peter's Square, Vatican City</span>
              </div>
              <div className="mt-1">
                <FontAwesomeIcon icon={faFacebookF} />
                <span className="ms-1"> leanSaber1255</span>
              </div>
              <div className="mt-1">
                <FontAwesomeIcon icon={faLinkedinIn} />
                <span className="ms-1"> shreyas_arya</span>
              </div>
              <div className="mt-1">
                <FontAwesomeIcon icon={faTwitter} />
                <span className="ms-1"> shrey768</span>
              </div>
            </div>
                      ...
                      <div className="col cards">
                        <div className="card-body">
                          ...
                          <p className="card-text">
                            <small className="text-muted">3 min read</small>
                          </p>
                        </div>
                      </div>
                    </div>
